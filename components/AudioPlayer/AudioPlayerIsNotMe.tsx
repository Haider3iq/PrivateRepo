...
const AudioPlayerIsNotMe = ({ soundURI}, props) => {
...
const onPlaybackStatusUpdate = (status: AVPlaybackStatus) => {
    ...
    <View style={{marginRight: "52%"}}>
        <View style={styles.soundPlayer}>
                ...
                <Ionicons name={paused ? "play" : "pause"} size={20} color="#555658" />
                </Pressable>
            ...
            <View style={styles.textContainer}>
                <Text style={{color: "#555658", marginLeft: -11,}}>{getDuration()}</Text>
            </View>
    </View>
    )
}
...
export default AudioPlayerIsNotMe