...
return (
      ...
      <View style={styles.header}>
        ...
        <View style={Platform.OS === "ios" ? {borderWidth: 1.5, borderColor: "white", borderRadius: 5, padding: 2, marginRight: 5} : {borderWidth: 1.5, borderColor: "white", borderRadius: 5, padding: 2, marginRight: 5,} } >
               ...
               <Text style={{color: "white", fontWeight: "700", fontSize: 22,}} > SavedMessages </Text>
        ...
        <View style={Platform.OS === "ios" ? {borderWidth: 1.5, borderColor: "white", borderRadius: 5, padding: 2, marginRight: 5} : {borderWidth: 1.5, borderColor: "white", borderRadius: 5, padding: 2, marginRight: 5,} } >
        <MaterialCommunityIcons name="account-box-multiple" size={30} color="white" />
               </View>
...
export default SavedMessagesHeader;